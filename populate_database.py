...
def populate_services(db: Session):
    ...
    services = [
        ...
        Service(name="Грунтовка стен", unit="кв.м", price=100),
        Service(name="Покраска стен", unit="кв.м", price=450),
        Service(name="Оклейка стен обоями", unit="кв.м", price=300),
        Service(name="Укладка керамической плитки", unit="кв.м", price=1200),
        Service(name="Укладка ламината", unit="кв.м", price=700),
        Service(name="Укладка паркетной доски", unit="кв.м", price=1000),
        
        # Потолочные работы
        Service(name="Монтаж натяжного потолка", unit="кв.м", price=900),
        Service(name="Монтаж гипсокартонного потолка", unit="кв.м", price=700),
        Service(name="Покраска потолка", unit="кв.м", price=500),
    ]
    ...
    work_definitions = [
        {
            ...
            "services_with_quantities": [
                ...
                (14, 20.0), # Укладка плитки - 20 кв.м
            ]
        },
        {
            ...
            "services_with_quantities": [
                (12, 35.0), # Шпатлевка стен - 35 кв.м
                (13, 35.0), # Покраска стен - 35 кв.м
                (16, 12.0), # Укладка ламината - 12 кв.м
                (7, 6.0),   # Установка розеток - 6 шт
                (19, 12.0), # Покраска потолка - 12 кв.м
            ]
        },
        {
            ...
            "services_with_quantities": [
                (11, 45.0), # Штукатурка стен - 45 кв.м
                (14, 45.0), # Оклейка обоями - 45 кв.м
                (17, 18.0), # Укладка паркета - 18 кв.м
        ...
        },
        {
            ...
            "services_with_quantities": [
                ...
                (14, 15.0), # Укладка плитки - 15 кв.м
                (19, 4.0),  # Покраска потолка - 4 кв.м
...
def populate_database():
    ...
    try:
        ...
        if works:
            ...
            print(f"Площадь: {work.square} кв.м, Цена: {work.price:,} ₽")
